...
class Logo
{
    ...
    public function postData()
    {
        ...
        if (isset($_POST['file_name'])) {
            ...
            $logo = $this->uploadFile($file_name);

            $sql = "UPDATE pel_client_co SET company_logo = :logo WHERE company_code = :company_id LIMIT 1";
            $params = [':logo'=> $logo,':company_id'=>$company_id];
